...
As light passes through water, metallic or transparent surfaces, the refraction of light causes a phenomenon known as caustics. Caustics are famously difficult to simulate with a limited time budget [\[1\]](https://www.zotero.org/google-docs/?ptcR9h), leading to them being ignored or roughly handled.

![][image1]  
Fig 1: Caustics created from light passing through the surface of the water [\[2\]](https://www.zotero.org/google-docs/?jn3xDu).

Taking inspiration from previous projects in the course;

[https://simulatingoptics.wordpress.com/](https://simulatingoptics.wordpress.com/) 
...
[Link: https://togezard.github.io/DD1354-project/](https://togezard.github.io/DD1354-project/) 
